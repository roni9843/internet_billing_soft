...
const CascadingDropdowns = ({ options, value, onChange, label }) => {
    // value expected to be a string like "Level1 > Level2" or an array
...
const AddClient = () => {
    ...
    if (loading) return <div className="p-8 text-center">Loading form configuration...</div>;
            ...
            >
                ...
                {fieldConfigs.length === 0 && (
                    <div className="text-center py-10 border-2 border-dashed border-gray-800 rounded-2xl text-gray-500">
                        No fields configured. Go to <span className="text-blue-500 font-bold">Settings</span> to add fields first.
                    </div>
                )}
                ...
                <div className="pt-6 border-t border-gray-800">
                    <button 
                        ...
                        className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white py-4 rounded-xl font-bold text-lg shadow-lg shadow-blue-900/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                    >
                        <Save size={22} />
                        Save Client
                    </button>
